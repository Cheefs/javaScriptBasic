...
// Мне интересно несколько ли плоха подобная запись, и читаема ли она вобще, 
// либо лучше использовать swithc или if  
